    ...
    <div class="min-h-[calc(100vh-64px)] flex items-center justify-center px-6 py-12 bg-zinc-50 dark:bg-zinc-950">
        <div class="w-full max-w-md bg-white dark:bg-zinc-900 rounded-[2.5rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-zinc-100 dark:border-zinc-800">
            <div class="text-center mb-10">
                <h1 class="text-3xl font-display font-bold text-zinc-900 dark:text-zinc-50 tracking-tight mb-2">Buat Akun</h1>
                <p class="text-zinc-500 dark:text-zinc-400 text-sm">Bergabunglah bersama kami dan nikmati kemudahan sewa mobil.</p>
            </div>
            ...
            <div class="mt-6 pt-6 border-t border-zinc-100 dark:border-zinc-800">
                <a href="{{ route('auth.google') }}" class="w-full h-14 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-full flex items-center justify-center gap-3 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors shadow-sm">
                    ...
                    <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300">Daftar dengan Google</span>
                </a>
            </div>

            <div class="mt-10 text-center">
                <p class="text-sm text-zinc-500">Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-zinc-900 dark:text-zinc-50 font-bold hover:underline">Masuk</a>
                </p>
            </div>
        </div>
    </div>
