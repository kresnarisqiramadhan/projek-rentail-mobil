<x-profile-layout>
    ...
    <section class="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-2xl overflow-hidden">
        <div class="p-12 text-center">
            ...
            <h3 class="text-zinc-900 dark:text-zinc-50 font-medium mb-1">{{ __('No favorites yet') }}</h3>
            <p class="text-zinc-500 text-sm font-light mb-6">{{ __('Tap the heart icon on any vehicle to save it here.') }}</p>
